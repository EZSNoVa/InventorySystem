...
class Slide(Animation):
    ...
    '''
    def __init__(self, object, start="current", end=["center", "center"], time=30, step=5, loop=False, done_callback=None):
        super().__init__(object, start, end, time, step, loop, done_callback)
